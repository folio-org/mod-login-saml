...
public class TenantClientGeneralized extends TenantClient {
  ...
  /**
   * Service endpoint "/_/tenant/"+operationId+""+queryParams.toString()
   *
  */
  @Override
  public Future<HttpResponse<Buffer>> deleteTenantByOperationId(String operationId) {
    // Auto-generated code
    // - generated by       org.folio.rest.tools.ClientGenerator
    // - generated based on org.folio.rest.jaxrs.resource.TenantResource
    StringBuilder queryParams = new StringBuilder("?");
    io.vertx.ext.web.client.HttpRequest<Buffer> request = webClientLocal.requestAbs(io.vertx.core.http.HttpMethod.DELETE, moduleUrlLocal+"/_/tenant/"+operationId+""+queryParams.toString());
   ...
   */
  @Override
  public Future<HttpResponse<Buffer>> getTenantByOperationId(String operationId, int wait) {
    // Auto-generated code
    // - generated by       org.folio.rest.tools.ClientGenerator
    // - generated based on org.folio.rest.jaxrs.resource.TenantResource
    StringBuilder queryParams = new StringBuilder("?");
    ...
    queryParams.append(wait);
    queryParams.append("&");
    io.vertx.ext.web.client.HttpRequest<Buffer> request = webClientLocal.requestAbs(io.vertx.core.http.HttpMethod.GET, moduleUrlLocal+"/_/tenant/"+operationId+""+queryParams.toString());
